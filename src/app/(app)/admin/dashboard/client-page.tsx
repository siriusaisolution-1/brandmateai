...
export default function AdminDashboardClientPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card className="bg-surface border-primary/40" data-testid="admin-stats">
        <CardHeader>
          <CardTitle>Administrative Metrics</CardTitle>
          <CardDescription>
            Snapshot of system health, ingestion volume, and automation throughput for administrators.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-primary" data-testid="admin-stats-status">
            Admin Stats loaded
          </p>
          <dl className="grid gap-4 md:grid-cols-3" data-testid="admin-stats-grid">
            <div className="rounded-lg border border-border/60 bg-background/40 p-4">
              <dt className="text-sm text-muted-foreground">Active Brands</dt>
              <dd className="text-2xl font-semibold text-copy-primary">24</dd>
            </div>
            <div className="rounded-lg border border-border/60 bg-background/40 p-4">
              <dt className="text-sm text-muted-foreground">Queued Automations</dt>
              <dd className="text-2xl font-semibold text-copy-primary">7</dd>
            </div>
            <div className="rounded-lg border border-border/60 bg-background/40 p-4">
              <dt className="text-sm text-muted-foreground">Data Freshness</dt>
              <dd className="text-2xl font-semibold text-copy-primary">4 min</dd>
            </div>
          </dl>
        </CardContent>
      </Card>
