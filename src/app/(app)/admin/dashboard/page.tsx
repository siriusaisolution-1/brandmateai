  ...
  const actions: WatchtowerAction[] = [
    {
      ...
      run: async () => {
        await runCompetitorWatchtower(buildWatchtowerRequest());
      },
    },
    {
      id: 'trend',
      ...
      run: async () => {
        await runTrendAndOpportunityRadar(buildWatchtowerRequest());
      },
    },
    {
      id: 'ads',
      ...
      run: async () => {
        await runSyncAdPerformance(buildWatchtowerRequest());
      },
    },
  ];
    ...
    async (action: WatchtowerAction) => {
      ...
      try {
        ...
        toast({
          ...
          description: `${action.label} successfully recorded.`,
        });
      } catch (error) {
        const message =
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      {watchtowersEnabled && (
        <Card className="bg-surface border-primary/40" data-testid="watchtower-actions">
          <CardHeader>
            <CardTitle>Watchtower Automations</CardTitle>
            <CardDescription>
